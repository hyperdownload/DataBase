...
class Slideout(ctk.CTkFrame):
    def __init__(self, parent, side="right", width=100, height=100, bg_color="gray", text="", y_axis=1, **kwargs):
        super().__init__(parent, width=width, height=height, border_width=3, corner_radius=20, **kwargs)
        self.parent = parent
        self.side = side
        self.width = width
        self.height = height
        ...
        self.close_button = ctk.CTkButton(self, text="X", width=20, height=20, command=self.slide_out)
